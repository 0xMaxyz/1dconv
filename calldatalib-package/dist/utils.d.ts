...
export declare function encodePacked(types: string[], values: any[]): Uint8Array;
...
export declare function getMorphoCollateral(market: any): Address;
export declare function getMorphoLoanAsset(market: any): Address;
